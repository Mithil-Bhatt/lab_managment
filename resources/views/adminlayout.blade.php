                    ...
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                        ...
                        <div class="box" id="myDiv">
                            <div class="form-wrapper">
                                ...
                                <br>
                                <a href='/data'><button class="sign-btn">Enter</button></a>
                            </div>
                            <div class="form-wrapper">
                               ...
                               <a href='/labdata'> <button class="sign-btn">Enter</button></a>
                            </div>
                            <div class="form-wrapper">
                                ...
                                <a href='/computerdata'><button class="sign-btn">Enter</button></a>
                            </div>
                            <div class="form-wrapper">
                                ...
                                <a href='/hardwaredata'><button class="sign-btn">Enter</button></a>
                            </div>
                            <div class="form-wrapper">
                               ...
                               <a href='/softwaredata'> <button class="sign-btn">Enter</button></a>
                            </div>
                            <div class="form-wrapper">
